...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_7__hero_service__["a" /* HeroService */], __WEBPACK_IMPORTED_MODULE_9__message_service__["a" /* MessageService */]],
...
module.exports = "<div *ngIf=\"hero\">\n  <h2>{{ hero.name | uppercase }} Details</h2>\n  <div><span>ID: </span>{{hero.id}}</div>\n  <div>\n    <label>Name:</label>\n    <input [(ngModel)]=\"hero.name\" placeholder=\"name\"/>\n  </div>\n  <button (click)=\"goBack()\">go back</button>\n  <button (click)=\"save()\">save</button>\n</div>\n\n<div *ngIf=\"returnHero\">\n  <div><span>returnHero: </span>{{returnHero.name}}</div>\n</div>"
...
var HeroDetailComponent = /** @class */ (function () {
    ...
    HeroDetailComponent.prototype.save = function () {
        var _this = this;
        this.heroService.updateHero(this.hero).subscribe(function (returnHero) { return _this.returnHero = returnHero; });
    };
    __decorate([
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1__hero__["a" /* Hero */])
    ], HeroDetailComponent.prototype, "returnHero", void 0);
...
var HeroService = /** @class */ (function () {
    function HeroService(http, messageService) {
        ...
        this.heroesUrl = 'http://localhost:8081/api/hero'; // URL to web api
    }
    ...
    HeroService.prototype.addHero = function (hero) {
        var _this = this;
        return this.http.post(this.heroesUrl, hero, httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["b" /* tap */])(function (hero) { return _this.log("added hero w/ id=" + hero.id); }), Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["a" /* catchError */])(this.handleError('addHero')));
    };
    HeroService.prototype.deleteHero = function (hero) {
        var _this = this;
        var id = typeof hero === 'number' ? hero : hero.id;
        var url = this.heroesUrl + "?id=" + id;
        return this.http.delete(url, httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["b" /* tap */])(function (_) { return _this.log("deleted hero id=" + id); }), Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["a" /* catchError */])(this.handleError('deleteHero')));
    };
    HeroService.prototype.updateHero = function (hero) {
        //return this.http.get<string>(this.heroesUrl + `updateHero?hero=${hero}`);
        var _this = this;
        return this.http.put(this.heroesUrl, hero, httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["b" /* tap */])(function (_) { return _this.log("updated hero id=" + hero.id); }), Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["a" /* catchError */])(this.handleError('updateHero')));
    };
    /**
